...
class BillController extends AdminController
{
    ...
    protected function form()
    {
        ...
        $form->hasMany('detailbill', "Bill details", function (Form\NestedForm $form) {
            ...
            $form->select('drug_id', __('Drug'))->options($drugs_associate)->loads(['DonGia', 'ChietKhau'], ['api/order/bills/autoGeneratePrice', 'api/order/bills/autoGenerateDiscount'])->rules('required');
            $form->number('DonGia', __('Price'))->rules('required')->readonly();
            $form->decimal('ChietKhau', __('Discount'))->rules('required')->readonly();
